...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/ood_datadrive/ood/dataset", type=str)
    parser.add_argument("--save_dir", default="/ood_datadrive/ood/results/GalLoP", type=str)
    parser.add_argument("--checkpoint_path", default="/ood_datadrive/ood/models/GalLoP/output/imagenet/LoCoOp/vit_b16_ep50_16shots/nctx16_cscFalse_ctpend/seed2/prompt_learner/checkpoint", type=str)
    parser.add_argument("--dataset_name", default="imagenet", type=str)
    parser.add_argument("--eval_only", default=True, type=lib.boolean_flags)
    parser.add_argument("--eval_ood", default=True, type=lib.boolean_flags)
    parser.add_argument("--eval_domains", default=True, type=lib.boolean_flags)

    parser.add_argument("--seed", default=2, type=int)
    parser.add_argument("--num_shots", default=16, type=int, help="Number of shots by class. -1 means the whole dataset")
    parser.add_argument("--use_local_features", default=True, type=lib.boolean_flags)
    ...
    parser.add_argument("--n_global_prompts", default=4, type=int)
    parser.add_argument("--n_local_prompts", default=4, type=int)
    ...
    parser.add_argument("--parallel_text_encoder", default=True, type=lib.boolean_flags)
    parser.add_argument("--parallel_vision_encoder", default=True, type=lib.boolean_flags)

    parser.add_argument("--ood_method", default="GL-MCM", type=str)
    parser.add_argument("--ood_temp_scale", default=1.0, type=float)

    parser.add_argument("--clip_name", required=True, choices=clip_model_names[1], type=str)
    ...
    parser.add_argument("--checkpointing_segments", default=0, type=int, help="Number of segments used for gradient checkpointing for the text encoder.")
